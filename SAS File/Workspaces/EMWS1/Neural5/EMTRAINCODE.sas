...
train tech=NONE;
code file="H:\746\Decision Tree test\Workspaces\EMWS1\Neural5\SCORECODE.sas"
group=Neural5
;
;
code file="H:\746\Decision Tree test\Workspaces\EMWS1\Neural5\RESIDUALSCORECODE.sas"
group=Neural5
residual
;
;
