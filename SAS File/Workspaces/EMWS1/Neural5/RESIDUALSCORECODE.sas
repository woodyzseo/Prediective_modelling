...
*** *************************;
IF _DM_BAD EQ 0 THEN DO;
   H11  =    -11.1158442769842 * S_REP_wheel_base  +      1.5424755264853 * 
        S_REP_width ;
   H12  =    -0.69021997177432 * S_REP_wheel_base  +     0.46683541802581 * 
        S_REP_width ;
   H11  = H11  +     0.50055678411184 * IMP_num_of_doors2 ;
   H12  = H12  +     0.40000577541559 * IMP_num_of_doors2 ;
   H11  =    -6.91384747981808 + H11 ;
   H12  =     0.94194689761205 + H12 ;
   H11  = TANH(H11 );
   H12  = TANH(H12 );
END;
ELSE DO;
...
IF _DM_BAD EQ 0 THEN DO;
   P_Risk1  =     4.81098334076219 * H11  +     6.13975925925767 * H12 ;
   P_Risk1  =     0.77599742717436 + P_Risk1 ;
   P_Risk0  = 0; 
