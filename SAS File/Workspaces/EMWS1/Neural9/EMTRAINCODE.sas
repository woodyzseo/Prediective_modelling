...
train tech=NONE;
code file="H:\746\Decision Tree test\Workspaces\EMWS1\Neural9\SCORECODE.sas"
group=Neural9
;
;
code file="H:\746\Decision Tree test\Workspaces\EMWS1\Neural9\RESIDUALSCORECODE.sas"
group=Neural9
residual
;
;
