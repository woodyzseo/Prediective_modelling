...
train tech=NONE;
code file="H:\746\Decision Tree test\Workspaces\EMWS1\Neural3\SCORECODE.sas"
group=Neural3
;
;
code file="H:\746\Decision Tree test\Workspaces\EMWS1\Neural3\RESIDUALSCORECODE.sas"
group=Neural3
residual
;
;
