...
train tech=NONE;
code file="H:\746\Decision Tree test\Workspaces\EMWS1\Neural4\SCORECODE.sas"
group=Neural4
;
;
code file="H:\746\Decision Tree test\Workspaces\EMWS1\Neural4\RESIDUALSCORECODE.sas"
group=Neural4
residual
;
;
